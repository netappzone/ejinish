...
export default class CollectionAlsoLike extends Component {
  constructor(props) {
      super(props);
      this.state = {
          loading: true,
  ...
  getProducts = () => {
      ShopifyService.getProducts(this.props.collectionHandle, 'manual').then((result) => {
              ...
              if (this.state.error) {
                  ...
                  return (
                      <View style={styles.container}>
                          <View style={styles.horizontalScrollViewWrap}>
                              <Text style={styles.horizontalScrollViewTitle}>{ Language.t('similarProducts') }</Text>
                          </View>
                          <FlatList
